...
vim.api.nvim_set_keymap("n", "v", "<Esc>ma:lua _G.flash_local()<CR>", { noremap = true, silent = true })
vim.keymap.set({'n','x','o'}, 't', "<Esc>ma:lua _G.input_flash()<CR>", { desc = "Flash Jump + derecha" })
