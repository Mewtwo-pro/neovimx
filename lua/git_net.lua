...
-- ========================
local function open_terminal(current_dir)
...
function _G.input_git_net(mi_path)

  open_terminal(mi_path)
...
function _G.git_command()
  ...
  elseif _G.local_switch == "push" then
    -- actualizar una rama ya existente : 
    -- git push origin name_rama
    -- subir la data a una nueva rama:
    --send_cmd("git push -u origin " .. _G.name_rama)
    send_cmd("git push origin " .. _G.name_rama)
