...
function _G.input_range_chars()
    ...
    -- vim.o.lines es la altura total de la pantalla en líneas.
    -- Restamos la altura de la ventana (height), el borde (2 líneas) y 
    -- un par de líneas extra para dejar espacio a la línea de comandos/barra de estado.
    local row = vim.o.lines - height - 3
    
    -- vim.o.columns es el ancho total. Restamos el ancho de la ventana y un margen a la derecha (ej: 2 columnas).
