...
vim.api.nvim_set_keymap("n", "v", "ma:lua _G.CurrentCharJump()<CR>" ,{ noremap = true, silent= true})
vim.api.nvim_set_keymap("v", "t", "<Esc>ma:lua _G.input_my_flash()<CR>" ,{ noremap = true, silent= true})
vim.api.nvim_set_keymap("n", "t", "ma:lua _G.input_my_flash()<CR>" ,{ noremap = true, silent= true})
