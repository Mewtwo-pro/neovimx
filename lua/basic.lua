...
vim.api.nvim_set_keymap('n','<CR>b', 'G0', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n','<CR>m', 'gg', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n','<CR>w', '`[V`]', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n','<CR>a', '`[v`]', { noremap = true, silent = true })
...
function _G.mode_swich_tab()
    vim.api.nvim_set_keymap("n", "<BS>", ":tabnext<CR>", { noremap = true, silent = true })
    vim.api.nvim_set_keymap("n", "<Space>", ":tabprevious<CR>", { noremap = true, silent = true })
    print("mode Tab ")
end   
vim.api.nvim_set_keymap("n", "b", ":lua _G.mode_swich_tab()<CR>" ,{ noremap = true, silent= true})
...
vim.api.nvim_set_keymap('i','<Tab>on','<<', { noremap = true, silent = true })
vim.api.nvim_set_keymap('i','<Tab>ob','~', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('i','<Tab>op', '``<Left>', { noremap = true, silent = true })
...
vim.keymap.set('i', '<Tab>j', enable_number_mode, { desc = 'Activar modo numero' })    
